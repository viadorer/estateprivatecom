-- Estate Private - Seed Templates
-- Migration: 00002_seed_templates
-- Created: 2025-11-01

-- Insert contract templates
INSERT INTO contract_templates (template_key, name, description, template_content, variables, is_active) VALUES
('loi', 'Letter of Intent (LOI)', 'Dohoda o záměru - přístup k důvěrným informacím', 
'DOHODA O ZÁMĚRU
(Letter of Intent)
...
Příjemce: {{user_name}}
Email: {{user_email}}',
'["user_name","user_email","user_company","user_ico","entity_type","entity_name","signature_date","signature_time"]',
1);

INSERT INTO contract_templates (template_key, name, description, template_content, variables, is_active) VALUES
('brokerage_contract', 'Zprostředkovatelská smlouva', 'Smlouva o zprostředkování prodeje/pronájmu nemovitosti',
...
Zadavatel: {{user_name}}',
'["user_name","user_email","user_company","user_ico","transaction_type","property_title","property_address","commission_rate","commission_terms","valid_until","signature_date"]',
1);

INSERT INTO contract_templates (template_key, name, description, template_content, variables, is_active) VALUES
('agent_cooperation', 'Smlouva o spolupráci s agentem', 'Rámcová smlouva o spolupráci při založení agenta',
...
Email: {{agent_email}}',
'["agent_name","agent_email","agent_company","agent_ico","default_commission","signature_date"]',
1);
